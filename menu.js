...
const pizza = {
    ...
    popularity: 60,
    rating: 7,
    tags: ['white sauce pizzas', 'garlic lovers', 'a pesto lovers dream']
}
...
let cheese = new pizzas("cheese", 5, "childrens menu", 4, 5, ["GF", "Vegetarian"])

let foodArr = [pepperoni, meatLovers, margherita, hawaiian, cheese]
